...
type DummyReportData = {
  [key: string]: ReportRow[];
};

const dummyReportData: DummyReportData = {
  "Financial Summary": [
    { id: 1, metric: "Total Revenue", value: "Rp1,234,567" },
    { id: 2, metric: "Net Profit", value: "Rp345,678" },
    { id: 3, metric: "Operating Expenses", value: "Rp567,890" },
    { id: 4, metric: "Gross Margin", value: "28%" },
    { id: 5, metric: "Return on Investment", value: "15%" },
  ],
  "Customer Acquisition": [
    { id: 1, metric: "New Customers", value: "1,234" },
    { id: 2, metric: "Customer Acquisition Cost", value: "Rp50" },
    { id: 3, metric: "Conversion Rate", value: "3.5%" },
    { id: 4, metric: "Customer Lifetime Value", value: "Rp1,200" },
